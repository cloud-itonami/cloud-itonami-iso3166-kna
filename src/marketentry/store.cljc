(ns marketentry.store
  "SSoT for the Saint Kitts and Nevis (KNA) market-entry compliance
...
(defn demo-data
  ...
  `:notice-published-date` / `:bid-close-date` / `:notice-newspaper-
  count` are ground truth for the `notice-period-insufficient`
  flagship check (Procurement and Contract (Administration) Act,
  Cap. 23.36 s.13: >=42 days, >=2 newspapers); `:requires-business-
  licence?` / `:business-licence-verified?` are ground truth for the
  conditional Business Licence (Cap. 18.20) check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Fabrication Ltd" :portal "Procurement Board, Ministry of Finance"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :notice-published-date "2026-01-01" :bid-close-date "2026-02-12" :notice-newspaper-count 2
             :requires-business-licence? true :business-licence-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KNA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Procurement Board, Ministry of Finance"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :notice-published-date "2026-01-01" :bid-close-date "2026-02-12" :notice-newspaper-count 2
             :requires-business-licence? true :business-licence-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Procurement Board, Ministry of Finance"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "KNA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export Ltd" :portal "Procurement Board, Ministry of Finance"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :notice-published-date "2026-02-01" :bid-close-date "2026-02-12" :notice-newspaper-count 2
             :requires-business-licence? true :business-licence-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KNA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Procurement Board, Ministry of Finance"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :notice-published-date "2026-01-01" :bid-close-date "2026-02-12" :notice-newspaper-count 2
             :requires-business-licence? true :business-licence-verified? false
             :drafted? false :submitted? false
             :jurisdiction "KNA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Procurement Board, Ministry of Finance"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               notice-published-date bid-close-date notice-newspaper-count
                               requires-business-licence? business-licence-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    notice-published-date                 (assoc :engagement/notice-published-date notice-published-date)
    bid-close-date                        (assoc :engagement/bid-close-date bid-close-date)
    (some? notice-newspaper-count)        (assoc :engagement/notice-newspaper-count notice-newspaper-count)
    (some? requires-business-licence?)    (assoc :engagement/requires-business-licence? requires-business-licence?)
    (some? business-licence-verified?)    (assoc :engagement/business-licence-verified? business-licence-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/notice-published-date :engagement/bid-close-date :engagement/notice-newspaper-count
   :engagement/requires-business-licence? :engagement/business-licence-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :notice-published-date (:engagement/notice-published-date m)
     :bid-close-date (:engagement/bid-close-date m)
     :notice-newspaper-count (:engagement/notice-newspaper-count m 0)
     :requires-business-licence? (boolean (:engagement/requires-business-licence? m))
     :business-licence-verified? (boolean (:engagement/business-licence-verified? m))
